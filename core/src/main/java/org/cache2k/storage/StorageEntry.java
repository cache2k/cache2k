...
public interface StorageEntry {
  ...
  /**
   * Time of last access in millis. May be 0 if no access tracking is enabled
   * within the cache. This may be needed if there is a idle expiry configured.
   */
  long getLastUsed();

  /**
   * Milliseconds after an entry is expired.
   */
  long getMaxIdleTime();
