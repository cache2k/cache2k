 ...
 * @author Jens Wilke
 */
public class UniversalResilienceConfiguration
  implements SingletonConfigurationSection
  <UniversalResilienceConfiguration, UniversalResilienceConfiguration.Builder> {
  ...
  public static class Builder implements ConfigurationSectionBuilder<UniversalResilienceConfiguration> {

    private UniversalResilienceConfiguration config;

    private Builder(UniversalResilienceConfiguration config) {
      this.config = config;
    }
    ...
    @Override
    public UniversalResilienceConfiguration buildConfigurationSection() {
      return config;
    }
