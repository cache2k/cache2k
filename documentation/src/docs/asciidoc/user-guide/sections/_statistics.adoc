...
- link:{cache2k_docs}/apidocs/cache2k-api/index.html?org/cache2k/jmx/CacheInfoMXBean.html[MXBean for the cache]
- link:{cache2k_docs}/apidocs/cache2k-api/index.html?org/cache2k/jmx/CacheManagerInfoMXBean.html[MXBean for the cache manager]
