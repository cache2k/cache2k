...
The latest documentation for development for cache2k is available at:

- link:user-guide.html[User Guide - HTML Version ]
- link:user-guide.pdf[User Guide - PDF Version]
